...
At [eLife Pathways](https://elifepathways.org/), we believe that building a modern, open science ecosystem is impossible without high-quality, open, and machine-readable metadata. If we want to unlock the full potential of our current knowledge base, the underlying metadata needs to be complete. 
